...
class App extends Component {
  ...
  getBitmap = path => new Promise((resolve, reject) => {
    ...
    image.src = this.state.picture ? this.state.picture : path;
  ...
  render() {
    ...
    return (
      <div className="App">
        <div>
          <canvas ref="canvas" onClick={this.handleClickImage} id="canvasily" />
          <canvas ref="canvasResult" id="canvasily-result" />
          <div className="react-drpz">
